...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[NSUserDefaults standardUserDefaults] objectForKey:kYREmailFormsKey] == nil) {
        NSArray* dic = @[@{@"Apply Online": @"<subject:Yahoo is Interested in Speaking with You! - {studentFirstName} {studentLastName}><br />Hi {studentFirstName}!<br /><br />It was great meeting you at today's career fair!<br /><br />We are excited that you are interested in opportunities with Yahoo. To be considered further, you must apply online via the following link within 48 hours: {applicationLink}<br /><br />We look forward to your application and speaking with you again in the future.<br /><br />Yahoo Campus Recruiting"},
                         ...
                         @{@"Confirmation" : @"<subject:Yahoo is Interested in Speaking with You! - {studentFirstName} {studentLastName}><br />Hello {studentFirstName}!<br /><br />We are excited to have you interview with Yahoo on your school Campus. You will meet with members of our hiring team, who are eager to learn more about you and your professional goals.<br /><br />Your interview has been confirmed. Specific details can be found below along with application instructions and job description. We hope that you have a wonderful interivew experience with Yahoo. And of course, don't hesitate to email or call me if you have any questions.<br /><br /><br />Best of luck!<br /><br />signature<br /><br />INTERVIEW DETAILS:<br /><br />{appointments}<br />APPLICATION INSTRUCTIONS:<br /><br />Prior to your interview, please review the job description and apply online via the following link: {applicationLink}"},
                         @{@"Rejection" : @""}];
